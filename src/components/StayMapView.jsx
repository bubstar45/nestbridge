...
function StayCard({ l, active, onHover, onClick }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 5, marginTop: 5, flexWrap: 'wrap', alignItems: 'center' }}>
        {l.bedrooms != null && (
          <span style={{ fontSize: 10, padding: '2px 7px', borderRadius: 8, background: '#f3f4f6', color: '#4b5563' }}>
            {l.bedrooms} bd
          </span>
        )}
        {l.max_guests != null && (
        ...
        {rating != null && (
          <span style={{ fontSize: 10, color: '#e8590c', fontWeight: 600 }}>
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', width: '100%', height: 160, background: '#f3f4f6', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          ${listing.price_per_night?.toLocaleString()}<span style={{ fontSize: 10, fontWeight: 400, opacity: 0.85 }}>/night</span>
        </div>
...
export default function StayMapView({ listings = [] }) {
  ...
  useEffect(() => {
    ...
    const addMarkers = () => {
      ...
      if (addedCount > 0) {
        console.log(`Added ${addedCount} markers to stays map`)
      }
    }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: 'calc(100svh - 160px)', minHeight: 500, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        {/* Sidebar */}
        <div style={{ width: 230, flexShrink: 0, overflowY: 'auto', borderRight: '1px solid #e5e7eb', background: '#fff' }}>
          {filtered.length === 0 && (
