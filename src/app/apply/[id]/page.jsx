...
const STEPS = ['Personal Info', 'Employment', 'Rental History', 'Additional Info', 'Review & Pay']
...
export default function ApplyPage() {
  ...
  if (!isSignedIn) return (
    <div className="max-w-lg mx-auto px-6 py-20 text-center">
      ...
      <Link href="/sign-in" className="px-6 py-3 bg-brand-500 text-white rounded-xl font-semibold">Sign In</Link>
    </div>
  )
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        {/* Header */}
        <div className="mb-8">
          <Link href={`/rentals/${id}`} className="text-sm text-gray-500 hover:text-brand-500 mb-4 inline-block">
            ← Back to listing
          </Link>
          {listing && (
        ...
        <div className="bg-white border rounded-2xl p-6 mb-6">
          ...
          {step === 1 && (
            <div className="space-y-4">
              <h2 className="font-semibold text-gray-900 mb-4">Employment & Income</h2>
              <div>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <h2 className="font-semibold text-gray-900 mb-4">Rental History</h2>
              <div className="grid grid-cols-2 gap-4">
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Intended Stay Length</label>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <button onClick={() => set('has_pets', true)}
                  ...
                  <button onClick={() => set('has_pets', false)}
                    className={`px-5 py-2 rounded-lg border text-sm font-medium transition-colors ${!form.has_pets ? 'bg-brand-500 text-white border-brand-500' : 'border-gray-300 text-gray-600'}`}>
                    No
                  </button>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 space-y-4">
                <p className="text-xs text-gray-500 font-medium uppercase tracking-wide">Background Disclosures</p>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-900">Prior eviction?</p>
                    <p className="text-xs text-gray-400">Have you ever been evicted from a rental?</p>
                  </div>
                  <div className="flex gap-3">
                    <button onClick={() => set('prior_eviction', true)}
                    ...
                    <button onClick={() => set('prior_eviction', false)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-900">Criminal history?</p>
                    <p className="text-xs text-gray-400">Any felony convictions in the past 7 years?</p>
                  </div>
                  <div className="flex gap-3">
                    <button onClick={() => set('criminal_history', true)}
                    ...
                    <button onClick={() => set('criminal_history', false)}
            ...
            <div className="space-y-5">
              ...
              <div className="bg-brand-50 border border-brand-100 rounded-xl p-5">
                <div className="flex justify-between items-center mb-2">
                  <span className="font-semibold text-gray-900">Application Fee</span>
                  <span className="text-2xl font-bold text-brand-500">$50</span>
                </div>
        ...
        <div className="flex gap-3">
          ...
          {step < 4 ? (
            ...
            <button onClick={handleSubmit} disabled={submitting}
              ...
              {submitting ? 'Submitting...' : 'Submit Application — $50'}
            </button>
          )}
        </div>
      </div>
